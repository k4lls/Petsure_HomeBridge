...
SurePetcareOccupancySensor.prototype = Object.create(SurePetcareAccessory.prototype);
SurePetcareOccupancySensor.prototype.constructor = SurePetcareOccupancySensor;
    ...
    var pets = data.data.pets;
        ...
        for(var i in pets) {
            ...
            if(pet.id == this.sensor.id) {
                if(pet.position == null || pet.position.where == undefined) {
                    return;
                }
...
SurePetcareOccupancySensor.prototype._getOccupancy = function(callback) {
    ...
    this.session.getStatuses(function(data) {
        if(data == null || data.data == null || data.data.pets == null) {
