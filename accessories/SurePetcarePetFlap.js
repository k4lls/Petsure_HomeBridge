...
SurePetcarePetFlap.prototype = Object.create(SurePetcareAccessory.prototype);
SurePetcarePetFlap.prototype.constructor = SurePetcarePetFlap;

SurePetcarePetFlap.prototype.pollStatus = function(data) {
    for(var index in data.data.devices) {
...
SurePetcarePetFlap.prototype._getLockState = function(callback) {
    this.session.getLockStatus(this.lock.id, function(data) {
        if(data == null || data.status == null || data.status.locking == null) {
